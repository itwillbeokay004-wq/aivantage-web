    ...
    <div className="relative overflow-hidden rounded-lg border border-white/10 bg-[#07101f] p-5 shadow-panel">
      ...
      <div className="relative">
        <div className="mb-6 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-sm font-semibold text-cyan-200">Agent workflow</p>
            ...
            return (
              <div key={node.title} className="relative">
                <motion.div
                  ...
                  className="relative z-10 h-full rounded-lg border border-white/10 bg-[#050914]/85 p-4"
                >
                ...
                {!isLast ? (
                  <>
                    <div className="absolute left-1/2 top-full z-0 h-4 w-px -translate-x-1/2 bg-cyan-300/20 lg:left-full lg:top-1/2 lg:h-px lg:w-4 lg:-translate-y-1/2 lg:translate-x-0" />
                    <motion.div
                      aria-hidden="true"
                      className="absolute left-1/2 top-full z-0 h-4 w-px -translate-x-1/2 bg-gradient-to-b from-cyan-200 to-purple-300 lg:left-full lg:top-1/2 lg:h-px lg:w-4 lg:-translate-y-1/2 lg:translate-x-0 lg:bg-gradient-to-r"
